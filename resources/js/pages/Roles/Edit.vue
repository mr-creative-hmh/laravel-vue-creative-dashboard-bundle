                ...
                <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                    ...
                    <div class="max-w-md">
                        ...
                        <input
                            ...
                            class="mt-1.5 h-10 w-full rounded-md border border-neutral-200 bg-white px-3 text-sm focus:border-neutral-400 focus:outline-none focus:ring-1 focus:ring-neutral-400 disabled:bg-neutral-100 disabled:opacity-70 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100 dark:disabled:bg-neutral-800"
                            required
                        />
                    ...
                    <div class="mt-8">
                        ...
                        <p class="text-xs text-neutral-500 dark:text-neutral-400">
                            {{ t('Toggle permissions assigned to this role.') }}
                        </p>
