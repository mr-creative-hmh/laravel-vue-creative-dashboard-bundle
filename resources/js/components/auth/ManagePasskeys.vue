...
import PasskeyItem from '@/components/auth/PasskeyItem.vue';
    ...
    <div v-if="canManagePasskeys" class="space-y-6">
        ...
        <div class="overflow-hidden rounded-lg border border-slate-200 dark:border-slate-800">
            ...
            <div v-else class="p-8 text-center">
                ...
                >
                    <KeyRound class="h-7 w-7 text-slate-600 dark:text-slate-400" />
                </div>
                <p class="font-medium text-slate-900 dark:text-white">No passkeys yet</p>
